...
*  Version 1.1.3 - Added a variety of strings as options in lieu of using icons.
*
**/

import groovy.transform.Field
import java.text.DecimalFormat
@Field static final Version = "<b>Tile Builder Rooms v1.1.3 (3/21/24 @ 9:10 AM)</b>"
...
def textStrings() { return ["Text: Vacant", "Text: Occupied", "Text: Off","Text: On","Text: Wet","Text: Dry","Text: Hot","Text: Normal","Text: Cold","Text: Home","Text: Away","Text: Present","Text: Not Present",\
                           "Text: Locked","Text: Unlocked","Text: Busy","Text: Quiet","Text: Slow","Text: Medium","Text: Fast","Text: Dim","Text: Bright","Text: Open","Text: Closed","Text: Smoke","Text: Clear","Text: Online","Text: Offline", "Text: Alarm"] }
...
def allIcons() { myIconList = ( textStrings() + alarmIcons() + batteryIcons() + buttonIcons() + carbonDioxideIcons() + climateIcons() + contactIcons() + deviceIcons() + emojiNumberIcons() + enclosedLetterIcons() + letterIcons() + enclosedNumberIcons() +fanIcons() + furnitureIcons() + geometricIcons() + healthIcons() + illuminanceIcons() + \
