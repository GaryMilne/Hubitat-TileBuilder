...
@Field static final Version = "<b>Tile Builder Activity Monitor v1.4.5 (1/3/24)</b>"
...
def mainPage() {
    ...
    refreshTable()
    refreshUIbefore()
    def pageTitle = (parent.checkLicense() == true) ? "Activity Monitor - Advanced" : "Activity Monitor - Standard";
