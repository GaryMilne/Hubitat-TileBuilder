...
@Field static final codeDescription = "<b>Tile Builder Attribute Monitor v1.5.4 (12/30/24)</b>"
...
def updateVariables() {
    ...
    //Update variables from version 1.4.0 to 1.4.8
    if (state.variablesVersion < 148 ) {
        log.info ("Updating Variables to Version 1.4.8")
        //Add the newly created variables.
		app.updateSetting("republishDelay", [value:"0", type:"enum"])
